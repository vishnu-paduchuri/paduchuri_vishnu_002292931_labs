...
public class AddSupplier extends javax.swing.JPanel {
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        String supplierDesc = txtDesc.getText();
        
        
        if(supplierName.isBlank()) {
            JOptionPane.showMessageDialog(this, "Supplier Name can't be empty");
            return;
        }
        
        if(supplierDesc.isBlank()) {
            JOptionPane.showMessageDialog(this, "Supplier Description can't be empty");
            return;
        }
        
        Supplier supplier = supplierDirectory.addSupplier();
        supplier.setSupplyName(supplierName);
        supplier.setSupplyDesc(supplierDesc);
        supplier.setSupplierImage(logoImage);
