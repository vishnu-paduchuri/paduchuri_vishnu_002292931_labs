...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    public ManageProductCatalogJPanel(JPanel workArea, Supplier supplier) {
        ...
        if(supplier.getSupplierImage()!= null) imgLogo.setIcon(supplier.getSupplierImage());
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        ViewProductDetailJPanel viewProductDetailsPanel = new ViewProductDetailJPanel(workArea, supplier, selectedProduct);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        CreateNewProductJPanel createNewProductPanel = new CreateNewProductJPanel(workArea, supplier);
        workArea.add("SupplierWorkAreaJPanel", createNewProductPanel);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int row=tblProducts.getSelectedRow();
        if(row < 0){
            JOptionPane.showMessageDialog(null, "Please select a row from the table first to delete", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        Product selectedProduct=(Product) tblProducts.getValueAt(row, 0);
