...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void populateProductTable(String keyword) {
        ...
        for (Supplier supplierItem: supplierDirectory.getSupplierlist()) {
            for (Product productItem: supplierItem.getProductCatalog().getProductcatalog() ) {
                if (productItem.getProdName().equalsIgnoreCase(keyword)) {
                    Object row[] = new Object [4];
                    row[0] = productItem;
                    row[1] = productItem.getModelNumber();
                    row[2] = productItem.getPrice();
                    row[3] = productItem.getAvail();
                    model.addRow(row);
                }
            }
        }
    ...
    private void btnProductDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductDetailsActionPerformed
        ...
        userProcessContainer.add("ViewProductByCustomerJPanel", vpdp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
       ...
       JOptionPane. showMessageDialog(this, "Thank you for your purchase!! we look forward to seeing you again! ");
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try {
            ...
            JOptionPane. showMessageDialog(this, "Please check the modified quantity fields entered!!");
            return;
        }

        int oldQuant = item.getQuantity();
        if (item.getProduct().getAvail() + oldQuant < quant) {
            JOptionPane. showMessageDialog(this, "Please check the products availability!!");
            return;
        }
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        userProcessContainer.add("ViewCartItemJPanel", voidp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next (userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (salesPrice < product.getPrice()) {
            JOptionPane. showMessageDialog(this, "Price should be more than it is set in the price column under the table!!");
            return;
        }
    ...
    private void populateCartTable() {
        ...
        for (OrderItem orederItem : currentOrder.getOrderItemList()) {
            Object row[] = new Object [4];
            row[0] = orederItem;
            row[1] = orederItem.getSalesPrice();
            row[2] = orederItem.getQuantity();
            row[3] = orederItem.getQuantity() * orederItem.getSalesPrice();
            model.addRow(row);
        }
    }
}
